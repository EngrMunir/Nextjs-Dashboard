...
const StudentForm = ({type, data,}:{type:"create"|"update"; data?:any}) => {
    ...
    return (
        <form className="flex flex-col gap-8" onSubmit={onSubmit}>
            ...
            <InputField label="Email" type="email" name="email" defaultValue={data?.email} register={register} error={errors.username}/>
            <InputField label="password" name="password" type="password" defaultValue={data?.password} register={register} error={errors.username}/>
            </div>
